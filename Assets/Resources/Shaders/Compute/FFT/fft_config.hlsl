...
// #define SIZE_729
    ...
    #define SIZE 2048
		...
		#define THREAD_REMAP
	#endif
	// #define PASSES_COUNT 11
	// #define RADIX_SEQ [PASSES_COUNT] = {2,2,2,2,2,2,2,2,2,2,2}
 ...
 //    #define MIN_RADIX 2
	...
	// #define RADIX_SEQ [PASSES_COUNT] = {9,12,12}
	// #define R9_SUBPASS_COUNT 2
	// #define R9_SUBPASS_RADIX_SEQ [R9_SUBPASS_COUNT] = {3,3}
	// #define R12_SUBPASS_COUNT 2
	// #define R12_SUBPASS_RADIX_SEQ [R12_SUBPASS_COUNT] = {3,4}
	// #define EX_PASS_DEC DECLARE_RN_PASS(12,SUBPASS(3) SUBPASS(4) )\
	// 	                DECLARE_RN_PASS(9,SUBPASS(3) SUBPASS(3))\
	// 	                DECLARE_RN_PASS_REV(12,SUBPASS_REV(2) SUBPASS_REV(4))\
	// 	                DECLARE_RN_PASS_REV(9,SUBPASS_REV(3) SUBPASS_REV(3))
	// #define FFT_PASSES RPN_PASS(9) RPN_PASS(12) RPN_PASS(12)
	// #define FFT_PASSES_REV RPN_PASS_REV(12) RPN_PASS_REV(12) RPN_PASS_REV(9)
	// #define MAX_RADIX 12
	// #define MIN_RADIX 9
	// #define MAX_SUBPASS_RADIX 3
	...
	// #define PASSES_COUNT 4
	// #define RADIX_SEQ [PASSES_COUNT] = {9,6,6,4}
	// #define R9_SUBPASS_COUNT 2
	// #define R9_SUBPASS_RADIX_SEQ [R9_SUBPASS_COUNT] = {3,3}
	...
	// #define FFT_PASSES RPN_PASS(9) RPN_PASS(6) RPN_PASS(6) R4_PASS
	// #define FFT_PASSES_REV R4_PASS_REV RPN_PASS_REV(6) RPN_PASS_REV(6) RPN_PASS_REV(9)  
	// #define MAX_RADIX 9
	// #define MIN_RADIX 4
	// #define MAX_SUBPASS_RADIX 3
	...
	// #define RADIX_SEQ [PASSES_COUNT] = {32,32}
 ...
 //    #define MIN_RADIX 32
	...
	// #define PASSES_COUNT 3
	// #define RADIX_SEQ [PASSES_COUNT] = {16,16,4}
	// #define FFT_PASSES PASS_LOOP(RN_PASS(16),2) R4_PASS
	// #define MAX_RADIX 16
	// #define MIN_RADIX 4

	// #define PASSES_COUNT 4
	// #define RADIX_SEQ [PASSES_COUNT] = {8,8,8,2}
 //    #define FFT_PASSES PASS_LOOP(RP2_PASS(8),3) R2_PASS
	// #define FFT_PASSES_REV R2_PASS_REV PASS_LOOP(RP2_PASS_REV(8),3)
 //    #define MAX_RADIX 8
 //    #define MIN_RADIX 2

	// #define PASSES_COUNT 4
	// #define RADIX_SEQ [PASSES_COUNT] = {8,8,8,2}
	// #define FFT_PASSES PASS_LOOP(RN_PASS(8),3) R2_PASS
	// #define MAX_RADIX 8
	// #define MIN_RADIX 2

	// #define PASSES_COUNT 5
	// #define RADIX_SEQ [PASSES_COUNT] = {4,4,4,4,4}
 ...
 //    #define MIN_RADIX 4
	...
	#define SIZE 972
		...
		#define INPLACE
	#endif
	// #define PASSES_COUNT 7
	// #define RADIX_SEQ [PASSES_COUNT] = {3,3,3,3,3,2,2}
	// #define FFT_PASSES PASS_LOOP(RN_PASS(3), 5) R2_PASS R2_PASS
	// #define MAX_RADIX 3
	// #define MIN_RADIX 2

	// #define PASSES_COUNT 6
	// #define RADIX_SEQ [PASSES_COUNT] = {3,3,3,3,3,4}
	// #define FFT_PASSES PASS_LOOP(RN_PASS(3), 5) R4_PASS
	// #define MAX_RADIX 4
	// #define MIN_RADIX 3

	// #define PASSES_COUNT 6
	// #define RADIX_SEQ [PASSES_COUNT] = {3,3,3,3,3,4}
	// #define FFT_PASSES R4_PASS RN_PASS(3) RN_PASS(3) RN_PASS(3) RN_PASS(3) RN_PASS(3) 
	// #define MAX_RADIX 4
	// #define MIN_RADIX 3
	...
	// #define R9_SUBPASS_COUNT 2
	// #define R9_SUBPASS_RADIX_SEQ [R9_SUBPASS_COUNT] = {3,3}
	// #define R12_SUBPASS_COUNT 3
	// #define R12_SUBPASS_RADIX_SEQ [R12_SUBPASS_COUNT] = {3,2,2}
	// #define EX_PASS_DEC DECLARE_RN_PASS(12,SUBPASS(3) SUBPASS(2) SUBPASS(2))\
	// 	                DECLARE_RN_PASS(9 ,SUBPASS(3) SUBPASS(3))\
	// 	                DECLARE_RN_PASS_REV(12,SUBPASS_REV(3) SUBPASS_REV(2) SUBPASS_REV(2) )\
	// 	                DECLARE_RN_PASS_REV(9 ,SUBPASS_REV(3) SUBPASS_REV(3))
	// #define MAX_SUBPASS_RADIX 3
	// #define PASSES_COUNT 3
	// #define RADIX_SEQ [PASSES_COUNT] = {9,9,12}
	// #define FFT_PASSES RPN_PASS(9) RPN_PASS(9) RPN_PASS(12)
	// #define FFT_PASSES_REV RPN_PASS_REV(12) RPN_PASS_REV(9) RPN_PASS_REV(9)
	// #define MAX_RADIX 12
	// #define MIN_RADIX 9

	// #define PASSES_COUNT 4
	// #define RADIX_SEQ [PASSES_COUNT] = {9,9,3,4}
	// #define R9_SUBPASS_COUNT 2
	// #define R9_SUBPASS_RADIX_SEQ [R9_SUBPASS_COUNT] = {3,3}
	// #define EX_PASS_DEC DECLARE_RN_PASS(9,SUBPASS(3) SUBPASS(3))\
	// 	                DECLARE_RN_PASS_REV(9,SUBPASS_REV(3) SUBPASS_REV(3))
	// #define FFT_PASSES PASS_LOOP(RPN_PASS(9), 2) RN_PASS(3) R4_PASS
	// #define FFT_PASSES_REV R4_PASS_REV RN_PASS_REV(3) PASS_LOOP(RPN_PASS_REV(9), 2)
	// #define MAX_RADIX 9
	// #define MIN_RADIX 3
	// #define MAX_SUBPASS_RADIX 3
	...
	#endif
	// #define PASSES_COUNT 6
	// #define RADIX_SEQ [PASSES_COUNT] = {3,3,3,3,3,3}
	// #define FFT_PASSES PASS_LOOP(RN_PASS(3), 6)
	// #define MAX_RADIX 3
	// #define MIN_RADIX 3

	// #define PASSES_COUNT 3
	// #define RADIX_SEQ [PASSES_COUNT] = {9,9,9}
	// #define FFT_PASSES PASS_LOOP(RN_PASS(9), 3)
	// #define MAX_RADIX 9
	// #define MIN_RADIX 9
	// #define MAX_SUBPASS_RADIX 3
	...
	#endif
	// #define PASSES_COUNT 2
	// #define RADIX_SEQ [PASSES_COUNT] = {27,27}
	// #define R27_SUBPASS_COUNT 3
	// #define R27_SUBPASS_RADIX_SEQ [R27_SUBPASS_COUNT] = {3,3,3}
	// #define EX_PASS_DEC DECLARE_RN_PASS(27,SUBPASS(3) SUBPASS(3) SUBPASS_N(3))
	// #define FFT_PASSES RPN_PASS(27) RPN_PASS(27)
	// #define MAX_RADIX 27
	// #define MIN_RADIX 27
	// #define MAX_SUBPASS_RADIX 3
 ...
 //    #define MIN_RADIX 2
	...
	//
	// #define PASSES_COUNT 3
	// #define RADIX_SEQ [PASSES_COUNT] = {8,8,4}
	// #define FFT_PASSES PASS_LOOP(RP2_PASS(8),2) RP2_PASS(4) 
	// #define FFT_PASSES_REV PASS_LOOP(RP2_PASS_REV(8),2) RP2_PASS_REV(4)
	// #define MAX_RADIX 8
	// #define MIN_RADIX 4
	// #define INPLACE
#endif
...
// #define GS_TYPE half4
// #define complex half2
// #define complex2 half4
